        ...
        <Router>
          ...
          <div className="body">
            <Routes>
              ...
              <Route path="/hostelowner" element={(storage?.user?.username && storage?.user?.isHostelOwner == "true") ? <Owner /> : <Error />} />
              <Route path="/map" element={<HostelMap />} />
              <Route
                path="/resetpassword/:id/:token"
                element={<ResetPassword />}
              />
              <Route path="/admin" element={storage?.user?.username && storage?.user?.isAdmin == "true" ? <Admin /> : <Error />} />
